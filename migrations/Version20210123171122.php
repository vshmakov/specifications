 ...
 */
final class Version20210123171122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD CONSTRAINT FK_527EDB252E65C292 FOREIGN KEY (performed_by_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
